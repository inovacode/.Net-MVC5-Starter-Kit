<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="500.aspx.cs" Inherits="UserPortal.Pages.Errors._500" %>
...
<body>
	<div class="error-page-wrap">
		<article class="error-page gradient">
			<hgroup>
				<h1>500</h1>
				<h2>oops! An unhandled<br/>error was thrown</h2>
			</hgroup>
			<a href="/" title="To home page" class="error-back">home page &raquo;</a>
		</article>
        <div style="margin-top:-180px;">We've logged the details of this error for further investigation. If this error continues, please contact our support team for help.</div>
	</div>
</body>
</html>
