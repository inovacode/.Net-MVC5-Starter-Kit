    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            if (ModelState.IsValid)
            {
                ...
                // To enable/disable password failures to trigger account lockout, change to shouldLockout: true
        ...
        public async Task<ActionResult> Register(UserViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new CodeLib.ApplicationUser { UserName = model.Email, Email = model.Email };
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                //bool isEmailConfirmed = (user != null) ? (await UserManager.IsEmailConfirmedAsync(user.Id)) : false;
                ...
                if (!EmailTemplate.SendForgotPasswordEmail(user, callbackUrl))
                    CommonDAL.InsertExceptionLog(DatabaseIdEnum.LogType_SiteException, "The forgot password email failed to send to " + user.Email, "AccountController.cs >> ForgotPassword()", user.Id.ToString());
